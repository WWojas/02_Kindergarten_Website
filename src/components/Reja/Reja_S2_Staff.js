                ...
                <div class='row align-items-center '>
                    ...
                    <div className='col-lg-2 col-md-offset-1  section_2_thumbnail'>
                        <NavLink to ="/our_philosophy">
                            <img src='images/staff/filozofia.svg' className='section_2_thumbnail_img' />
                            <p class="pt-2"> Nasza Filozofia</p>
                        </NavLink>
                    </div>
                    <div className='col-lg-2 col-md-offset-1 section_2_thumbnail'>
                        <NavLink to ="/extended_offer">
                            <img src='images/staff/what_we_offer.svg' className='section_2_thumbnail_img' />
                            <p className="pt-2"> Co oferujemy</p>
                        </NavLink>
                    </div>
                    <div className='col-lg-2 col-md-offset-1 section_2_thumbnail'>
                        <NavLink to ="/enrollment">
                            <img src='images/staff/zapisy.svg' className='section_2_thumbnail_img' />
